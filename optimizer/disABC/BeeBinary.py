...
from .BeePrototype import BeeProtype
...
class BeeBinary(BeeProtype):
    ...
    def randomize(self):
        ...
        value = self.fitness_fun(self.vector)[0]
    ...
    def crossover(self, bee, hive_state):
        ...
        value = zombee.fitness_fun(zombee.vector)[0]
    ...
    def __init__(self, dimensions, fun, theta_min=0.5, theta_max=0.9):
        ...
        def fun2(vector):
            return -fun(np.array(vector))
        self.fitness_fun = fun2
