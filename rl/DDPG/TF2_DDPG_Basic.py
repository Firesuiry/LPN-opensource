...
class DDPG:
    ...
    def plot_graph(self):
        tf.keras.utils.plot_model(self.actor, to_file='./dada/actor.png', show_shapes=True, show_layer_names=True, rankdir='TB',
                                  dpi=900, expand_nested=True)
        tf.keras.utils.plot_model(self.critic, to_file='./dada/critic.png', show_shapes=True, show_layer_names=True, rankdir='TB',
                                  dpi=900, expand_nested=True)
